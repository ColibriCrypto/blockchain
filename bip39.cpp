...
std::string AddressTobip39Hash(const std::string& address)
{
...
std::string bip39_Encrypt(std::string strAddress, std::string strPassphrase, uint256 privKey, bool fCompressed)
{
    std::string strAddressHash = AddressTobip39Hash(strAddress);
...
bool bip39_Decrypt(std::string strPassphrase, std::string strEncryptedKey, uint256& privKey, bool& fCompressed)
{
    std::string strKey;
    ...
    return strAddressHash == AddressTobip39Hash(address);
}
