...
// clbi: on startup load spork values from previous session if they exist in the sporkDB
void CSporkManager::LoadSporksFromDB()
{
    for (const auto& sporkDef : sporkDefs) {
        ...
        if (spork.nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2) {
            ...
            // 1578338986 is the timestamp that spork 15 was last signed at for   for the previous
            ...
            // version handshake process. This value is also suitable for   as the timestamp
