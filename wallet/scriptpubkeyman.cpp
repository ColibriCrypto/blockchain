...
{
    AssertLockHeld(wallet->cs_wallet);
    // Use BIP44 keypath scheme i.e. m / purpose' /  _type' / account' / change / address_index
    CKey seed;                     //seed (256bit)
    CExtKey masterKey;             //hd master key
    CExtKey purposeKey;            //key at m/purpose' --> key at m/44'
    CExtKey  typeKey;           //key at m/purpose'/ _type'  --> key at m/44'/119'
    CExtKey accountKey;            //key at m/purpose'/ _type'/account' ---> key at m/44'/119'/account_num'
    CExtKey changeKey;             //key at m/purpose'/ _type'/account'/change ---> key at m/44'/119'/account_num'/change', external = 0' or internal = 1'.
    CExtKey childKey;              //key at m/purpose'/ _type'/account'/change/address_index ---> key at m/44'/119'/account_num'/change'/<n>'
    ...
    // derive m/purpose'/ _type'
    purposeKey.Derive( typeKey, 119 | BIP32_HARDENED_KEY_LIMIT);
    // derive m/purpose'/ _type'/account' // Hardcoded to account 0 for now.
     typeKey.Derive(accountKey, nAccountNumber | BIP32_HARDENED_KEY_LIMIT);
    // derive m/purpose'/ _type'/account'/change'
