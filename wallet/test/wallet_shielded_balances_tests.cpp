...
BOOST_AUTO_TEST_CASE(GetShieldedAvailableCredit)
{
    ...
    // 1) generate a shielded address and send 20 clbi in two shielded outputs
    libzcash::SaplingPaymentAddress pa = wallet.GenerateNewSaplingZKey();
    CAmount credit =   * 20;
