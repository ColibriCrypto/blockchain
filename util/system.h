 ...
 * thread wrappers
 */
#ifndef CLBI_UTIL_SYSTEM_H
#define CLBI_UTIL_SYSTEM_H
...
extern const char * const clbi_CONF_FILENAME;
extern const char * const clbi_PID_FILENAME;
extern const char * const clbi_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("clbi-%s", name);
