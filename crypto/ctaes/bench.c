...
static void run_clbi(char *name, void (*clbi)(void*), void (*setup)(void*), void (*teardown)(void*), void* data, int count, int iter) {
    int i;
    double min = HUGE_VAL;
    double sum = 0.0;
    double max = 0.0;
...
int main(void) {
    ...
    AES192_ctx ctx192;
    AES256_ctx ctx256;
    run_clbi("aes128_init", bench_AES128_init, NULL, NULL, &ctx128, 20, 50000);
    run_clbi("aes128_encrypt_byte", bench_AES128_encrypt, bench_AES128_encrypt_setup, NULL, &ctx128, 20, 4000000);
    run_clbi("aes128_decrypt_byte", bench_AES128_decrypt, bench_AES128_encrypt_setup, NULL, &ctx128, 20, 4000000);
    run_clbi("aes192_init", bench_AES192_init, NULL, NULL, &ctx192, 20, 50000);
    run_clbi("aes192_encrypt_byte", bench_AES192_encrypt, bench_AES192_encrypt_setup, NULL, &ctx192, 20, 4000000);
    run_clbi("aes192_decrypt_byte", bench_AES192_decrypt, bench_AES192_encrypt_setup, NULL, &ctx192, 20, 4000000);
    run_clbi("aes256_init", bench_AES256_init, NULL, NULL, &ctx256, 20, 50000);
    run_clbi("aes256_encrypt_byte", bench_AES256_encrypt, bench_AES256_encrypt_setup, NULL, &ctx256, 20, 4000000);
    run_clbi("aes256_decrypt_byte", bench_AES256_decrypt, bench_AES256_encrypt_setup, NULL, &ctx256, 20, 4000000);
    return 0;
}
