...
* No tables or data-dependent branches whatsoever, but using bit sliced approach from https://eprint.iacr.org/ /129.pdf.
...
Results of a formal review of the code can be found in http://CLBI.sipa.be/ctaes/review.zip
