...
#ifndef clbi_DETERMINISTICMNS_H
#define clbi_DETERMINISTICMNS_H
...
public:
    ...
    // the returned list will not contain the correct block hash (we can't know it yet as the  base TX is not updated yet)
