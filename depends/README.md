...
A prefix will be generated that's suitable for plugging into CLBI's
configure. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for CLBI:
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_clbi` executable (see https://github.com/CLBI/CLBI/pull/13543),
...
<dt>NO_NAT clbi</dt>
<dd>Don't download/build/cache packages needed for enabling NAT- clbi</dd>
<dt>NO_RUST</dt>
...
options will be passed to CLBI's configure. In this case, `--disable-wallet`.
