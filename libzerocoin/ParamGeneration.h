...
///
/// \brief      Parameter generation routines for Zero .
///
/// \author       
/// \date       June  
///
...
void CalculateParams(Zero Params &params, const CBigNum& N, const std::string& aux, uint32_t securityLevel);
void calculateGroupParamLengths(uint32_t maxPLen, uint32_t securityLevel, uint32_t *pLen, uint32_t *qLen);

// Constants
#define STRING_COMMIT_GROUP         " _COMMITMENT_GROUP"
